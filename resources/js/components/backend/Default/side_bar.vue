<template>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <router-link to="/home" class="brand-link text-center">
      ...
      <span class="brand-text font-weight-light">Jacos CRM</span>
    </router-link>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex text-center">
        ...
        <div class="info">
            <h6><router-link :to="{ name: 'user_update', query: { user_id: user.id } }" class="d-block" v-can="['user_profile_view']">{{user.name}} <b-icon icon="circle-fill" variant="success" animation="throb" font-scale="1"></b-icon></router-link></h6> 
