                ...
                <div class="card-body">
                   <form @submit.prevent="submitForm" @keydown="form.onKeydown($event)">
                        <div class="form-row">
                            ...
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-success btn-sm float-right"> <b-icon icon="file-earmark" class="far" font-scale="1.2"></b-icon> Save</button>
                            </div>
                        </div>
                 ...
                 this.form.post('buyer-store')
                    .then(({ data }) => { 
                        if(data.success){
                            ...
                            this.$router.push({name:'buyer_manage'})
                        }
                    })
            }
