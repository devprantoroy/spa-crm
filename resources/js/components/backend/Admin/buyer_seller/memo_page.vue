                    ...
                    <table class="table  table-sm  mb-5  table-hover">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="pointer_class" @click="sorting('start_date')">Date Time<span class="float-right" :class="iconSet('start_date')"></span> </th> 
                                <th class="pointer_class" @click="sorting('end_date')">Memo<span class="float-right" :class="iconSet('end_date')"></span> </th> 
                                <th class="pointer_class" @click="sorting('count')">Action <span class="float-right" :class="iconSet('count')"></span> </th> 
                            </tr>
                        </thead>
                        <tbody>
